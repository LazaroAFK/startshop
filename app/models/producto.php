...
class producto{
    ...
    public function listarProductos($limite, $pagina){
        ...
        // Consulta
        $this -> db -> query("SELECT a.id as id, nombre, precio, codigo, precio_proveedor, id_proveedor, id_inventario, if(isnull(cantidad), 0, cantidad) as cantidad FROM productos a LEFT JOIN inventario b ON a.id_inventario = b.id LIMIT $offset, $limite");
