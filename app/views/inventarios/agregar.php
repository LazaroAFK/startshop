...
action="<?= URLROOT ?>/inventarios/agregar" method="POST">
  <div class="flex-none flex flex-nowrap gap-2">
    ...
    <a href="<?= URLROOT; ?>/inventarios/agregar" class="flex-none h-8 px-3 rounded bg-gray-200 flex items-center justify-center">
  ...
  <div class="flex-none mb-10 flex gap-3">
    ...
    <div class="flex-none w-96 px-1 flex flex-col gap-4">
      <div class="flex flex-col">
        <label for="" class="w-72 p-px font-medium">Lote</label>
        <input name="lote" class="flex-grow h-8 px-2 rounded border-2 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-300" />
      </div>
      <div class="flex flex-col">
        <label for="" class="p-px font-medium">Fecha</label>
        <input name="fecha" type="date" class="flex-grow h-8 px-2 rounded border-2 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-300" />
      </div>
    </div>
  </div>
  <div class="flex-none mb-10 flex gap-3">
    ...
    <div class="flex-none w-96 px-1 flex flex-col gap-4">
      <div class="flex flex-col">
        ...
        <input name="id_producto" class="flex-grow h-8 px-2 rounded border-2 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-300" />
      </div>
      <div class="flex flex-col">
        <label for="" class="w-72 p-px">Total</label>
        <input name="total" class="flex-grow h-8 px-2 rounded border-2 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-300" />
      </div>
      <div class="flex flex-col">
        <label for="" class="w-72 p-px">Cantidad</label>
        <input name="cantidad" class="flex-grow h-8 px-2 rounded border-2 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-300" />
      </div>
      <div class="flex flex-col">
