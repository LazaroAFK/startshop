    ...
    <table>
        ...
        <tbody class="h-14 text-xl">
            ...
            <tr class="h-12 bg-gray-200">
                ...
                <td class="flex gap-2">
                  <a href="<?= URLROOT; ?>/productos/editar/<?= $data['productos'][$i] -> id ?>">
                  ...
                  <a href="<?= URLROOT; ?>/productos/eliminar/<?= $data['productos'][$i] -> id ?>">
            ...
            <tr class="h-12 bg-gray-200">
                ...
                <td>
                  <a href="<?= URLROOT; ?>/productos/editar/<?= $data['productos'][$i + 1] -> id ?>" class="rounded bg-blue-400">Editar</a>
                  <a href="<?= URLROOT; ?>/productos/eliminar/<?= $data['productos'][$i + 1] -> id ?>" class="rounded bg-red-400">Eliminar</a>
                </td>
            </tr>
            <?php }} ?>
        </tbody>
